...
VERSION_SYM = 0_040_004
DEFINE_VERSION = -D$(VERSION_MACRO)=\"$(VERSION)\"
XS_VERSION = 0.040_004
...
DISTVNAME = XML-OPML-SimpleGen-0.040_004
...
metafile : create_distdir
	...
	$(NOECHO) $(ECHO) 'version:            0.040_004' >> META_new.yml
...
ppd :
	$(NOECHO) $(ECHO) '<SOFTPKG NAME="$(DISTNAME)" VERSION="0.040_004">' > $(DISTNAME).ppd
