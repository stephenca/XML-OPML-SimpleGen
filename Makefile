...
VERSION_SYM = 0_040_001
DEFINE_VERSION = -D$(VERSION_MACRO)=\"$(VERSION)\"
XS_VERSION = 0.040_001
...
MAKE = make
FULLEXT = XML/OPML/SimpleGen
BASEEXT = SimpleGen
PARENT_NAME = XML::OPML
DLBASE = $(BASEEXT)
VERSION_FROM = 
OBJECT = 
LDFROM = $(OBJECT)
...
H_FILES  = 
MAN1PODS = 
MAN3PODS = lib/XML/OPML/SimpleGen.pm

# Where is the Config information that we are using/depend on
CONFIGDEP = $(PERL_ARCHLIB)$(DFSEP)Config.pm $(PERL_INC)$(DFSEP)config.h

# Where to build things
INST_LIBDIR      = $(INST_LIB)/XML/OPML
INST_ARCHLIBDIR  = $(INST_ARCHLIB)/XML/OPML
...
TO_INST_PM = lib/XML/OPML/SimpleGen.pm

PM_TO_BLIB = lib/XML/OPML/SimpleGen.pm \
...
DISTVNAME = XML-OPML-SimpleGen-0.040_001
...
manifypods : pure_all  \
	...
	$(NOECHO) $(POD2MAN) --section=3 --perm_rw=$(PERM_RW) \
	  lib/XML/OPML/SimpleGen.pm $(INST_MAN3DIR)/XML::OPML::SimpleGen.$(MAN3EXT) 
...
metafile : create_distdir
	...
	$(NOECHO) $(ECHO) 'version:            0.040_001' >> META_new.yml
...
ppd :
	$(NOECHO) $(ECHO) '<SOFTPKG NAME="$(DISTNAME)" VERSION="0.040_001">' > $(DISTNAME).ppd
...
pm_to_blib : $(FIRST_MAKEFILE) $(TO_INST_PM)
	$(NOECHO) $(ABSPERLRUN) -MExtUtils::Install -e 'pm_to_blib({@ARGV}, '\''$(INST_LIB)/auto'\'', q[$(PM_FILTER)], '\''$(PERM_DIR)'\'')' -- \
	  lib/XML/OPML/SimpleGen.pm blib/lib/XML/OPML/SimpleGen.pm 
